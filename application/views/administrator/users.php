            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Etudiant</a>
                        </li>
                        <li class="breadcrumb-item"><a href="#!">Liste Etudiants</a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                ...
                                <?php foreach($users as $post) : ?>
                                 <tr>
                                        ...
                                        <td><a href="edit-blog.php?id=14"><?php echo $post['name']; ?> <?php echo $post['username']; ?></a></td>
