	...
	class Administrator extends CI_Controller{
	  ...
	  // Log in Admin
		public function adminLogin(){
			...
			if($this->form_validation->run() === FALSE){
				...
				if ($user_id && $user_id->role_id == 1) {
					...
					//Set Message
					$this->session->set_flashdata('success', 'Bienvenue sur le plateform de control.');
					redirect('administrator/dashboard');
				}else{
		...
		public function logout(){
			...
			//Set Message
			$this->session->set_flashdata('success', 'Vous ête deconnecté.');
		...
		public function add_user($page = 'add-user')
		{
			...
			$data['title'] = 'Ajouter un Etudiant';
			...
			if($this->form_validation->run() === FALSE){
				...
				//Set Message
				$this->session->set_flashdata('success', "L'utilisateur a été cree avec succes .");
		...
		public function delete($id)
		{
			...
			$this->session->set_flashdata('success', 'Le donneé a été supprimer avec succes.');
		...
		public function enable($id)
		{
			...
			$this->session->set_flashdata('success', 'Desactivé avec succes.');
			header('Location: ' . $_SERVER['HTTP_REFERER']);
		}
		public function desable($id)
		{
			...
			$this->session->set_flashdata('success', 'Activativation avec success.');
			header('Location: ' . $_SERVER['HTTP_REFERER']);
		}
		...
		public function update_user($id = NULL)
		{
			...
			$data['title'] = 'Modifier un Etudiant';
